...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('gambar/logokecil.png') }}" class="img-circle">
                      </div>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('gambar/logokecil.png') }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{ url('gambar/logokecil.png') }}" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><small>@yield('header')</small></h1>
    </section>
