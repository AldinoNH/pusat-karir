...
<table class="table">
      ...
      <tr>       
        ...
        <th width="50px">:</th>
        <th>{{ $pengajuan->judul_lowongan }}</th>
        </tr>
      <tr>
        <th width="150px">Tgl Awal</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->tgl_awal }}</th>
        </tr>
      <tr>
        <th width="150px">Tgl Akhir</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->tgl_akhir }}</th>
        </tr>
      <tr>
        <th width="150px">Kualifikasi</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->kualifikasi }}</th>
        </tr>
      <tr>
        <th width="150px">persyaratan</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->persyaratan }}</th>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <th width="50px">:</th>
        <th>{{ $pengajuan->kabupatenkota }}</th>
        </tr>
      <tr>
        <th width="150px">provinsi</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->provinsi }}</th>
        </tr>
      <tr>
        <th width="150px">kodepos</th>
        <th width="50px">:</th>
        <th>{{ $pengajuan->kodepos }}</th>
        </tr>
      <tr>
        <th width="150px">Logo</th>
        <th width="50px">:</th>
        <th><img src="{{ url('fotopengajuan/'.$pengajuan->foto) }}" width="400px" alt=""></th>
      </tr>
      <tr>
