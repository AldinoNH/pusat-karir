...
<table class="table">
      <tr>
        <th width="150px">Nama Berita</th>
        <th width="50px">:</th>
        <th>{{ $tbl_berita->nama_berita }}</th>
       </tr>
      <tr>
        <th width="150px">Deskripsi</th>
        <th width="50px">:</th>
        <th>{{ $tbl_berita->deskripsi }}</th>
        </tr>
      <tr>       
        <th width="150px">Pamflet Berita</th>
        <th width="50px">:</th>
        <th><img src="{{ url('foto_berita/'.$tbl_berita->foto_berita) }}" width="400px" alt=""></th>
      </tr>
      <tr>
