...
<table class="table">
      <tr>
        <th width="150px">Nama Event</th>
        <th width="50px">:</th>
        <th>{{ $tbl_event->nama_event }}</th>
       </tr>
      <tr>
        <th width="150px">waktu</th>
        <th width="50px">:</th>
        <th>{{ $tbl_event->waktu }}</th>
        </tr>
      <tr>       
        <th width="150px">tipe</th>
        <th width="50px">:</th>
        <th>{{ $tbl_event->tipe }}</th>
        </tr>
      <tr>
        <th width="150px">deskripsi</th>
        <th width="50px">:</th>
        <th>{{ $tbl_event->deskripsi }}</th>
        </tr>
        <th width="150px">Pamflet Event</th>
        <th width="50px">:</th>
        <th><img src="{{ url('foto_event/'.$tbl_event->foto_event) }}" width="400px" alt=""></th>
      </tr>
      <tr>
