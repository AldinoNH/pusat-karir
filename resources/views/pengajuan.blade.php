...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="/admin/add/pengajuan" class="btn btn-primary btn-sm">Add</a>
        ...
        <tbody>
          ...
          @foreach ($pengajuan as $data)
            <tr>
              ...
              <td>{{ $data->provinsi }}</td>
              <td>{{ $data->kodepos }}</td>
              <td><img src="{{ url('fotopengajuan/'.$data->foto) }}" width="150px"></td>
              <td>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approve{{ $data->id_lowongan }}">
                Upload
                </button>
                <a href="/admin/detail/pengajuan/{{ $data->id_lowongan }}" class="btn btn-sm btn-success">Detail</a>
                <a href="/admin/editpengajuan/{{ $data->id_lowongan }}" class="btn btn-sm btn-warning">Edit</a>
      ...
      <div class="modal modal-danger fade" id="delete{{ $data->id_lowongan }}">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">No</button>
                <a href="/admin/deletepengajuan/{{ $data->id_lowongan }}" class="btn btn-outline">Yes</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
