      ...
      <div class="card bg-light">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <div>
              <button class="btn btn-secondary" id="btn-kategori" data-toggle="modal" data-target="#exampleModal">
        ...
        <div class="card-body p-0">
          <div class="d-flex">
            ...
            <div class="card-header kategori-responsive">
              ...
              <div class="row">
                <div class="col-12 py-4">
                  <form class="form-inline my-2 my-lg-0" method="GET">
                    <input class="form-control col-md-6 mr-sm-2" id="search-lowongan" type="search" placeholder="Search" aria-label="Search">
                  </form>
                </div>
              </div>
